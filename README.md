...
- **Alumnos** (`Cod_Alumno`, `Nombre`, `Email`) 
- **Cursos** (`Cod_Curso`, `Nombre`) 
- **Campus** (`Cod_Campus`, `Nombre`)
- **Promociones** (`Cod_Promocion`, `Cod_Curso`, `Cod_Campus`, `Fecha`) → Ej: Bilbao, 2024
- **Alumno_promocion** (`Cod_Alumno`, `Cod_Promocion`) → Relación entre alumno y promoción
...
- **Rol_profesor** (`Cod_Rol_Profesor`, `Cod_Profesor`, `Cod_Rol`) → Docencia desempeñada/profesor
- **Proyectos** (`Cod_Proyecto`, `Descripcion`) → Tipo de proyecto
